                ...
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  ...
                  <div>
                    <!--<div class="btn-wrapper"> -->
                       <div class="row">
                        <div class="col-sm-4">
                          <a  class="btn btn-otline-dark align-items-center"><i class="icon-share"></i> {{ Auth::user()->name }}</a>  
                        </div>
                        <div class="col-sm-8">
                          <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a:href="route('logout')"
                                    onclick="event.preventDefault();
                                                this.closest('form').submit();" class="btn btn-danger align-items-center">
                                Log Out
                            </a>
                          </form>
                        </div>
                      ...
                      <!-- <a href="logout" class="btn btn-otline-dark align-items-center"><i class="icon-share"></i> {{ __('Log Out') }}</a -->

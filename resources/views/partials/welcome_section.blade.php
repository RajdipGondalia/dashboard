<section class="lg:pl-60 md:pl-60 sm:pl-60 market-background relative">
        ...
        <div class="buy-card lg:w-full text-left ">
            <div class="flex justify-between">
                <div class="flex">
                    ...
                    <p class="text-xs self-center"><b class="text-2xl font-bold">Welcome Back {{ $current_user }}</b>
                        <br>Good Morning, Have a nice day</p>
                </div>

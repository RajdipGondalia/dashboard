                    ...
                    <table class="table table-striped table-responsive" style="display: inline-table!important;">
                      ...
                      <tbody>
                        ...
                        @foreach($clients as $client)
                          <tr>
                            <td>
                              <a href="{{ route('single_client_edit', $client->id) }}" title="Edit" style="margin-left: 10px;color: green;text-decoration: none" >
                                <i class="fa fa-edit"></i>
                              </a>
                              <a onclick="return confirm('Are you sure Delete This Client..?')"  href="{{ route('single_client_master_delete', $client->id) }}" title="Delete" style="margin-left: 10px;color: red;text-decoration: none" >
